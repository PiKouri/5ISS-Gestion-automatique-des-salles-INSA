...
async function postRoom(name: string) {
...
async function componentDidMount(): Promise<number[]> {
  try {
    return await fetcher(Links.rooms);
  } catch (e) {
    return [];
  }
}
...
export default function Home() {
  ...
  return (
    <div className="container">
      ...
      <main>
        <h1 className="title">Automatic Room Management 5ISS (HOK - FAURE)</h1>

        <p className="description">
          Manage INSA automatic room management system
        </p>
